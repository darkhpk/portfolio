"""
Django settings for web_classroom project.
"""
...
WSGI_APPLICATION = 'w_classroom.wsgi.application'
ASGI_APPLICATION = 'w_classroom.asgi.application'
